...
describe("GraphStore.getModuleCoupling() — Sprint 2 Track 1", () => {
    ...
    it("clamps coupling score to 1.0 for heavily coupled files", () => {
        ...
        for (let i = 0; i < 20; i++) {
            ...
            relationsA.push({ type: "defines", sourceSymbolId: "file:src/heavy_a.ts", targetSymbolId: `func:heavy_a:fn${i}`, filePath: "src/heavy_a.ts", confidence: 1 }, { type: "calls", sourceSymbolId: `func:heavy_a:fn${i}`, targetSymbolId: `func:heavy_b:fn${i}`, filePath: "src/heavy_a.ts", confidence: 0.9 });
            relationsB.push({ type: "defines", sourceSymbolId: "file:src/heavy_b.ts", targetSymbolId: `func:heavy_b:fn${i}`, filePath: "src/heavy_b.ts", confidence: 1 }, { type: "calls", sourceSymbolId: `func:heavy_b:fn${i}`, targetSymbolId: `func:heavy_a:fn${i}`, filePath: "src/heavy_b.ts", confidence: 0.9 });
        }
        store.upsertFileResult(makeFileResult({
            filePath: "src/heavy_a.ts",
            symbols: symbolsA,
...
//# sourceMappingURL=get-module-coupling.test.js.map