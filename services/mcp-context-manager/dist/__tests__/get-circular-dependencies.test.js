...
describe("GraphStore.getCircularDependencies() — Track 2 Sprint 3", () => {
    ...
    it("detects multi-file cycle A→B→C→A with correct chain order", () => {
        ...
        const cycle = result.cycles.find((c) => c.chain.includes("src/a.ts") && c.chain.includes("src/b.ts") && c.chain.includes("src/c.ts"));
...
//# sourceMappingURL=get-circular-dependencies.test.js.map