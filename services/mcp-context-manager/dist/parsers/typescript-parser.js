 ...
 */
function getRange(sourceFile, node) {
...
export async function parseTypeScriptFile(filePath, workspaceRoot) {
    ...
    const definitionPositions = new Set();
     ...
     */
    function addSymbol(name, kind, node, qualifiedNameOverride) {
     ...
     */
    function getEnclosingSymbolId(node) {
