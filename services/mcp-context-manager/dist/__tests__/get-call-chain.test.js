 ...
 */
function makeFileResult(overrides) {
    return {
        language: "typescript",
...
describe("GraphStore.getCallChain() — Track 4", () => {
    ...
    it("returns A←B→C→D for getCallChain('B', 'both') on chain A→B→C→D", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                // A → B → C → D
                { type: "calls", sourceSymbolId: "func:chain:A", targetSymbolId: "func:chain:B", filePath: "src/chain.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:chain:B", targetSymbolId: "func:chain:C", filePath: "src/chain.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:chain:C", targetSymbolId: "func:chain:D", filePath: "src/chain.ts", confidence: 1 },
            ],
        }));
    ...
    it("returns only upstream nodes for direction='upstream'", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "calls", sourceSymbolId: "func:up:A", targetSymbolId: "func:up:B", filePath: "src/up.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:up:B", targetSymbolId: "func:up:C", filePath: "src/up.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:up:C", targetSymbolId: "func:up:D", filePath: "src/up.ts", confidence: 1 },
            ],
        }));
    ...
    it("returns only downstream nodes for direction='downstream'", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "calls", sourceSymbolId: "func:down:A", targetSymbolId: "func:down:B", filePath: "src/down.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:down:B", targetSymbolId: "func:down:C", filePath: "src/down.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:down:C", targetSymbolId: "func:down:D", filePath: "src/down.ts", confidence: 1 },
            ],
        }));
    ...
    it("respects maxDepth limit", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "calls", sourceSymbolId: "func:depth:A", targetSymbolId: "func:depth:B", filePath: "src/depth.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:depth:B", targetSymbolId: "func:depth:C", filePath: "src/depth.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:depth:C", targetSymbolId: "func:depth:D", filePath: "src/depth.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:depth:D", targetSymbolId: "func:depth:E", filePath: "src/depth.ts", confidence: 1 },
            ],
        }));
    ...
    it("respects maxNodes limit and sets truncated flag", () => {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            relations.push({ type: "defines", sourceSymbolId: "file:src/fan.ts", targetSymbolId: id, filePath: "src/fan.ts", confidence: 1 }, { type: "calls", sourceSymbolId: "func:fan:root", targetSymbolId: id, filePath: "src/fan.ts", confidence: 1 });
        }
    ...
    it("respects AbortSignal for early termination", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "calls", sourceSymbolId: "func:abort:A", targetSymbolId: "func:abort:B", filePath: "src/abort.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:abort:B", targetSymbolId: "func:abort:C", filePath: "src/abort.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:abort:C", targetSymbolId: "func:abort:D", filePath: "src/abort.ts", confidence: 1 },
            ],
        }));
    ...
    it("handles diamond-shaped call graphs without duplicates", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "calls", sourceSymbolId: "func:diamond:A", targetSymbolId: "func:diamond:B", filePath: "src/diamond.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:diamond:A", targetSymbolId: "func:diamond:C", filePath: "src/diamond.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:diamond:B", targetSymbolId: "func:diamond:D", filePath: "src/diamond.ts", confidence: 1 },
                { type: "calls", sourceSymbolId: "func:diamond:C", targetSymbolId: "func:diamond:D", filePath: "src/diamond.ts", confidence: 1 },
            ],
        }));
...
//# sourceMappingURL=get-call-chain.test.js.map