...
describe("GraphStore.getCallers() — Track 3", () => {
    ...
    it("respects maxResults limit and sets truncated flag", () => {
        ...
        for (let i = 0; i < 10; i++) {
            ...
            relations.push({ type: "defines", sourceSymbolId: "file:src/fan.ts", targetSymbolId: id, filePath: "src/fan.ts", confidence: 1 }, { type: "calls", sourceSymbolId: id, targetSymbolId: "func:fan:target", filePath: "src/fan.ts", confidence: 1 });
        }
        store.upsertFileResult(makeFileResult({
            filePath: "src/fan.ts",
            symbols,
...
//# sourceMappingURL=get-callers.test.js.map