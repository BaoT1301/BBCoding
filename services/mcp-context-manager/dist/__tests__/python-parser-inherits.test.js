 ...
 */
async function parseSource(source, fileName = "test_module.py") {
...
`);
        ...
        const duckInherits = inheritsRelations.filter((r) => r.sourceSymbolId?.includes("Duck"));
...
//# sourceMappingURL=python-parser-inherits.test.js.map