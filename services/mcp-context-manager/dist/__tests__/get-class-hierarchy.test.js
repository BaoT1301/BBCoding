    ...
    it("Test 5: maxDepth limits traversal depth", () => {
        ...
        store.upsertFileResult(makeFileResult({
            ...
            relations: [
                ...
                { type: "inherits", sourceSymbolId: "class:deep:D", targetSymbolId: "class:deep:C", filePath: "src/deep.ts", confidence: 0.9 },
                { type: "inherits", sourceSymbolId: "class:deep:C", targetSymbolId: "class:deep:B", filePath: "src/deep.ts", confidence: 0.9 },
                { type: "inherits", sourceSymbolId: "class:deep:B", targetSymbolId: "class:deep:A", filePath: "src/deep.ts", confidence: 0.9 },
            ],
        }));
...
//# sourceMappingURL=get-class-hierarchy.test.js.map